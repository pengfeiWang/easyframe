...
;/*(function ( seajs ) {
	// seajs.modUrl = 'http://192.168.1.220/mooc/js/'//window.location.origin;
	seajs._pros = function () {
		var el = document.getElementById('seajsnode');
		var str = el.getAttribute('data').replace(/'/g, '"');
		var json = JSON ? JSON.parse(str) : eval( '(' +str+ ')');

		return {
			'page': json.page ? json.page : '',
			'pro': json.pro ? json.pro + '/' : ''
		}
	}();
})(seajs);
...
seajs.config({
	vars:  {
		'page': 'project/pro-' + seajs._pros[ "pro" ] + 'js/' + seajs._pros[ "page" ],
		'purl': 'project/pro-' + seajs._pros[ "pro" ] + 'js/init.js'
	},
	// base: 'http://192.168.1.220/mooc-java-sercer/bbt100/sources/trunk/web-static-file/js',
	alias: {
		// localhost
		"jquery"   : "lib/jquery-1.8.2.js",
		"doT"      : "lib/doT.js",
		"slide"    : "lib/slides-1.2.4.js",
		"utils"    : "lib/utils.js",
		"validate" : "lib/jquery.validate.js",
		"jcrop"    : "lib/jquery.jcrop.js",
		'page'     : '{page}'
		// server
		// "jquery"     :  "lib/jquery/1.8.3/jquery.js",
		// "doT"        :  "lib/doT/1.0.0/doT.js",
		// "slide"      :  "lib/slides/1.2.4/slides.js",
		// "validation" :  "lib/jquery-validation/1.13.1/jquery.validate.min.js",
		// "utils"      :  "lib/utils/1.0.0/utils.js"
	}
});
if ( !!seajs._pros[ "pro" ] ) {
	seajs.use('{purl}');
